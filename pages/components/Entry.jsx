...
const Overview = () => {
  ...
  return (
    <div className="min-h-[100px] max-h-[900px] z-10 :h-[749px] ml-auto mr-auto top-20 lg:top-32 relative flex lg:pt-0 justify-center content-center lg:flex-row flex-col-reverse">
      ...
      <div
        id="slider"
        className="max-h-[600px] z-20  relative overflow-x-scroll scroll scroll-smooth scrollbar-hide flex flex-row lg:flex-col lg:items-center mx-6 xl:px-40 lg:w-1/2 lg:py-0"
      >
        ...
        <div className="flex lg:py-3 flex-col lg:flex-row text-center lg:text-left lg:items-center w-36 h-24 lg:w-auto lg:h-auto">
          ...
          <div>
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <p className="text-xs lg:text-base text-gray-700 lg:ml-1 lg:mt-2">
                Zone
              </p>
            </div>
        ...
        <div className="flex lg:py-3 flex-col lg:flex-row text-center lg:text-left lg:items-center w-36 h-24 lg:w-auto lg:h-auto">
          ...
          <div>
            ...
            <div className="flex flex-col lg:flex-row">
              ...
              <p className="text-xs lg:text-base xl:text-lg text-gray-700 pl-1 md:mt-2">
                Club 2 – 11900sft
              </p>
            </div>
          </div>
